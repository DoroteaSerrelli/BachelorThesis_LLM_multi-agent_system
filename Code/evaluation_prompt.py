...
```
{
    ...
    "properties": {
        ...
        "Explanation": {
            "type": "string",
            "description": "A detailed explanation of identified issues, including bugs, security vulnerabilities, execution errors, and compilation errors. Each issue must be clearly described, followed by one or more suggested fixes, formatted as a numbered list.
